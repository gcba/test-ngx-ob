import { Step } from 'projects/obelisco-angular-lib/core/models';
...
export const LIST_STEP_DATA_SOURCE: DataSource[] = [
  ...
  },
  {
    ...
    description: {
      data: 'Se utiliza para determinar si se deben mostrar números en los pasos.',
      customClasses: '',
    },
  },
  {
    ...
    description: {
      data: 'Se utiliza para definir el tamaño de los pasos en el componente.',
      customClasses: '',
    },
  },
  {
...
export const LIST_STEP_STEP_INTERFACE_DATA_SOURCE: DataSource[] = [
  {
    ...
    description: {
      data: 'Se utiliza para especificar el título del paso',
      customClasses: '',
    },
  },
  {
